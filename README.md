...
Both pages include a language selector (English / 简体中文 / Bahasa Indonesia / ไทย / Tiếng Việt / Bahasa Melayu), remembered with `localStorage`.

## Update Flow

1. Edit `index.html` and/or `terms.html`
2. Commit and push to `main`
3. Wait for GitHub Pages rebuild
4. Verify both live URLs
